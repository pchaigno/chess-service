...
public class Board {
	...
	private Map<Character, List<BoardSquare>> squares;
	...
	public Board() {
		...
		this.squares = new HashMap<Character, List<BoardSquare>>();
		this.squares.put('a', new LinkedList<BoardSquare>());
		this.squares.put('b', new LinkedList<BoardSquare>());
		this.squares.put('c', new LinkedList<BoardSquare>());
		this.squares.put('d', new LinkedList<BoardSquare>());
		this.squares.put('e', new LinkedList<BoardSquare>());
		this.squares.put('f', new LinkedList<BoardSquare>());
		this.squares.put('g', new LinkedList<BoardSquare>());
		this.squares.put('h', new LinkedList<BoardSquare>());
	 ...
	 */
	public void addPiece(name, color, x, y) {
	 ...
	 */
	public List<Integer> getPiece(name, color, x, y) {
		List result = new ListLinked();
