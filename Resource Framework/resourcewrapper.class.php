...
class ResourceWrapper {
	...
	private $open_complete_fen; // False to remove the end of the FEN before submit.
	...
	private $end_complete_fen; // False to remove the end of the FEN before submit.
	...
	private $middle_complete_fen; // False to remove the end of the FEN before submit.

	
	// Constructor.
	public function __construct() {
		$this->complete_fen_openings = false;
		$this->middle_complete_fen = false;
		$this->end_complete_fen = false;
		$this->openings = false;
		$this->endings = false;
		$this->middle = false;
	}
	...
	public function setDatabaseOpenings($url, $version, $san, $parser = null, $complete_fen) {
		...
		$this->open_complete_fen = $complete_fen;
		if($san) {
	...
	public function setDatabaseEndings($url, $version, $san, $parser = null, $complete_fen) {
		...
		$this->end_complete_fen = $complete_fen;
		if($san) {
	...
	public function setMiddleGame($function, $version, $san, $complete_fen) {
		...
		$this->middle_complete_fen = $complete_fen;
		if($san) {
