...
Toute l'intelligence de notre système réside dans la seconde entité. Cette entité est un serveur qui va utiliser les ressources afin de déterminer le meilleur coup à jouer. Une fois ce coup déterminé, il va le renvoyer à la dernière entité : un client (jeu d'échecs classique).
