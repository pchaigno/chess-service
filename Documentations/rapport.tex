...
L'un des souhaits de Loïc Héloüet était d'utiliser REST (REpresentational State Transfer) comme style d'architecture. REST est un style d'architecture associant à une url un objet. De plus REST utilise un nombre réduit de méthode pour interagir avec ces objets. Les quatres actions de bases CRUD (Create, Read, Update et Delete) sont effectuées respectivement par des méthodes HTTP (POST, GET, PUT et DELETE).
...
[TODO: Parler du client 3D et du client AJAX]
