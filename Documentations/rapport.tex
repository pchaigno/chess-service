...
{Modèle entité-association de notre base de données}   
{fig:modele-bdd}
...
Le système décrit précédemment permet de bien prendre en compte la diversité des informations traitées mais il ne permet pas encore de différencier une ressource par rapport à une autre.
